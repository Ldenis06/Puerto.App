...
export const LibretasTab: React.FC<Props> = ({ isDenis, isUnavailable = false }) => {
  ...
  const publish = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const note = await publishNotebookNote(draft.trim());
