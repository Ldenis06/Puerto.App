...
interface Props { currentUser: User | null; onUpdateUser: (updatedUser: User) => void; onUpdateAvatar: (avatarUrl: string, password?: string) => Promise<void>; isAdmin: boolean; onClearAllExpenses: () => void; canChangeProfile: boolean; onUseProfileChange: () => void; }

export const PerfilTab: React.FC<Props> = ({ currentUser, onUpdateUser, onUpdateAvatar, isAdmin, onClearAllExpenses, canChangeProfile, onUseProfileChange }) => {
