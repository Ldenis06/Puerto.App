...
import { Camera, Check, Save, ShieldCheck, Sparkles, Trash2, Upload, User as UserIcon } from 'lucide-react';
import { User } from '../../types';

interface Props { currentUser: User | null; onUpdateUser: (updatedUser: User) => void; isAdmin: boolean; onClearAllExpenses: () => void; }

export const PerfilTab: React.FC<Props> = ({ currentUser, onUpdateUser, isAdmin, onClearAllExpenses }) => {
